...
namespace nova_ext_display_name;

defined('BASEPATH') OR exit('No direct script access allowed');

/**
 * Logic behind the Characters_model::get_character_name shim.
 *
 * Returns a character's display_name when set, otherwise the default
 * first-name / last-name / suffix combination - optionally prefixed
 * with the rank and wrapped in a bio anchor.
 */
class Character
{
